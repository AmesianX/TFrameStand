...
#ifndef FrameStandPackage_13HPP
#define FrameStandPackage_13HPP
...
#include <FMX.DisplayLink.hpp>	// (fmx)
...
#include <FMX.SpellChecker.Win.hpp>	// (fmx)
...
namespace Framestandpackage_13
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Framestandpackage_13 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRAMESTANDPACKAGE_13)
using namespace Framestandpackage_13;
#endif
#pragma pack(pop)
#pragma option pop
